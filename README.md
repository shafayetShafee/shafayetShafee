...
├─📦 <b>R Packages</b>  
│ ├─ <a href="https://shafayetshafee.github.io/MOR/">MOR</a>                   - Calculate Median Odds Ratio From a Fitted Multilevel Binary Logistic Model  
│ ├─ <a href="https://shafayetshafee.github.io/skmisc/">skmisc</a>                - package with some useful functions to make life easier  
...
├─🐍 <b>Python Packages</b>  
│ ├─ <a href="https://skmiscpy.readthedocs.io/en/latest/">skmiscpy</a>              - A python package providing Contains a few functions useful for data-analysis, causal inference etc.  
│ └─ <a href="https://github.com/shafayetShafee/kedrogen">kedrogen</a>              - A simple CLI command that generate a Kedro project from a cookiecutter template in the current directory.  
├─📜 <b>Bash Scripts</b>  
│ └─ <a href="https://github.com/shafayetShafee/uvshot">uvshot</a>                - Python setup scripts using uv  
├─🐳 <b>Docker Images</b>  
│ ├─ <a href="https://github.com/shafayetShafee/mad-coc-IPW">mad-coc-IPW</a>           - Contains docker image to reproduce of an analysis results  
│ └─ <a href="https://github.com/shafayetShafee/contained-thesis">contained-thesis</a>      - Contains docker image to reproduce of a simulation results  
├─📊 <b>DataViz</b>  
...
│ ├─ <a href="https://github.com/shafayetShafee/interactive-sql">interactive-sql</a>       - Run sql examples interactively in RevealJs slide or HTML files  
...
│ ├─ <a href="https://github.com/shafayetShafee/metropolis-beamer">metropolis-beamer</a>     - Another Quarto reveal.js template extension inspired by Beamer Metropolis theme  
│ ├─ <a href="https://github.com/shafayetShafee/metropolis">metropolis</a>            - Quarto reveal.js template extension inspired by Metropolis theme  
...
└─💡 <b>Other</b>  
  ├─ <a href="https://github.com/shafayetShafee/dbt-demo-project">DBT Demo Project</a>      - A Demo DBT Project  
